namespace SkipIntro
{
    ...
    internal static class ModPatcher
    {
        ...
        {
            SkipIntroMod.Log.LogDebug("Skipping the intro scene.");
        ...
        private static void NonVrBoot_Constructor_Prefix()
        {
            ...
            SkipIntroMod.Log.LogDebug("Temporarily setting a field required to skip the intro scene.");
        }

        private static void GlobalCanvasSystem_RunLoading_Prefix()
        {
            MotherbrainGlobalVars.isRunningBrainTests = false;
            SkipIntroMod.Log.LogDebug("Reverting temporarily field setting.");
        }
    }
}
