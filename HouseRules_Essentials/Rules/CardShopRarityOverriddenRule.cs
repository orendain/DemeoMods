namespace HouseRules.Essentials.Rules
{
    ...
    {
        public override string Description => "Card sell price is overridden";
            ...
            Dictionary<AbilityKey, int> cardProperties)
        {
            ...
            for (var i = 0; i < cardConfigs.Count; i++)
            {
                ...
                MelonLoader.MelonLogger.Msg(cardConfig.Card + ": Shop rarity set to " + cardProperties[cardConfig.Card]);
            }
