...
- **AbilityAoeAdjustedRule**: Adjusts the Area of Effect range(s) for abilities.
  ...
  - Positive integers increase range, negavive decrease. e.g. `"Fireball": 1` will increases the Fireball AOE from a 3x3 to 5x5
...
- **AbilityActionCostAdjustedRule**: Ability Action Cost is adjusted
    ...
    ```json
  {
    ...
    ```
- _**ActionPointsAdjustedRule**: Action points are adjusted_
...
- _**StartHealthAdjustedRule**: Starting Health is adjusted_
