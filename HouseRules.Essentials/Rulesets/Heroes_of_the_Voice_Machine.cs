    ...
    internal static class Heroes_of_the_Voice_Machine
    {
        internal static Ruleset Create()
        {
            ...
            var warlockCards = new List<StartCardsModifiedRule.CardConfig>
            {
                ...
                new StartCardsModifiedRule.CardConfig { Card = AbilityKey.Barrage, ReplenishFrequency = 0 },
            };
            ...
            var hunterCards = new List<StartCardsModifiedRule.CardConfig>
            {
                ...
                new StartCardsModifiedRule.CardConfig { Card = AbilityKey.EarthShatter, ReplenishFrequency = 0 },
            ...
            var pieceImmunityRule = new PieceImmunityListAdjustedRule(new Dictionary<BoardPieceId, List<EffectStateType>>
            {
                ...
                { BoardPieceId.WarlockMinion, new List<EffectStateType> { EffectStateType.CorruptedRage, EffectStateType.Stunned } },
            ...
            { PVPisOn = false, KillEnemy = 1, KillPlayer = -8, KillSelf = -10, KillBoss = 25, HurtEnemy = 1, HurtPlayer = -2, BuffPlayer = 2, HurtSelf = -5, HurtBoss = 3, Keyholder = 1, UnlockDoor = 20, LootGold = 2, LootChest = 3, LootStand = 4, OpenDoor = 1, UseFountain = 6, RevivePlayer = 4 });
