namespace HouseRules.Configuration.UI
{
    ...
    internal class HouseRulesUiGameVr2 : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            else if (ruleSet.Contains("LEGENDARY") || ruleSet.Contains("HARD"))
            {
